# Angular Boot Camp example: secondary-routes
...
**[StackBlitz for secondary-routes](https://stackblitz.io/github/AngularBootCamp/secondary-routes)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/secondary-routes.git
cd secondary-routes
npm install
npm start
```
